...
class DoctorAccessPermission(permissions.BasePermission):
    ...
    def has_permission(self, request, view):
        return 'api.view.doctor' in request.user.get_user_permissions()

class RoleBasePermissionsMixin:  #(permissions.BasePermission):
...
class HasPermissionByAuthenticatedUserRole(permissions.BasePermission):
    ...
    def get_user_permissions(user):
        ...
        return user.user_permissions.value_list('codename', flat=True) | Permission.objects.filter(
